...
function ShopCard({ imgSrc }) {
  return (
    <div className=" w-full overflow-hidden">
      <div
        className=" bg-no-repeat h-100 bg-center relative "
        style={{ backgroundImage: `url(${imgSrc})` }}
      >
        <div className="flex flex-col justify-center place-self-center bg-sky-600 opacity-75 px-6 py-6 min-w-86 absolute bottom-0 h-1/2">
