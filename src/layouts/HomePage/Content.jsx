...
function Content() {
  return (
    <div>
      <main className="flex flex-col gap-12.25 items-center md:flex-row md:justify-around">
        <section className="flex flex-col gap-4 text-start px-11.5 pb-12.5 md:order-1 md:w-2/5">
